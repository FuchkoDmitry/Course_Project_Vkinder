...
relation = {'замужем/женат': 4, 'не замужем/не женат': 1, 'есть друг/есть подруга': 2, 'в активном поиске': 6}
relation_reverse = {4: 'замужем/женат', 1: 'не замужем/не женат', 2: 'есть друг/есть подруга', 6: 'в активном поиске'}